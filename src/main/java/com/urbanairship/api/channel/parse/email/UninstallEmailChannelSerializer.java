...
public class UninstallEmailChannelSerializer extends JsonSerializer<UninstallEmailChannel> {
    ...
    @Override
    public void serialize(UninstallEmailChannel payload, JsonGenerator jgen, SerializerProvider serializerProvider) throws IOException, JsonProcessingException {
