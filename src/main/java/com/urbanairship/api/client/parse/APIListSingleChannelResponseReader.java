...
public class APIListSingleChannelResponseReader implements JsonObjectReader<APIListSingleChannelResponse> {
    ...
    public APIListSingleChannelResponseReader() { this.builder = APIListSingleChannelResponse.newBuilder(); }

    public void readChannelObject(JsonParser jsonParser) throws IOException { builder.setChannelObject(jsonParser.readValueAs(ChannelView.class)); }
