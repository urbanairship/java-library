...
import com.urbanairship.api.schedule.parse.ListSchedulesResponseDeserializer;
...
import com.urbanairship.api.schedule.parse.ScheduleResponseDeserializer;
...
public final class APIResponseObjectMapper {
    ...
    static {
        ...
        MODULE.addDeserializer(ScheduleResponse.class, new ScheduleResponseDeserializer());
        MODULE.addDeserializer(ListAllSchedulesResponse.class, new ListSchedulesResponseDeserializer());
