...
import com.urbanairship.api.push.model.notification.android.*;
...
import com.urbanairship.api.push.model.notification.wns.*;
...
import com.urbanairship.api.push.parse.notification.android.*;
...
public class PushObjectMapper {
    ...
    static {
        ...
        MODULE
                ...
                .addSerializer(PushNoThrottle.class, new PushNoThrottleSerializer())
                .addDeserializer(PushNoThrottle.class, new PushNoThrottleDeserializer())
