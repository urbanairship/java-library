...
public class NamedUserObjectMapper {
    ...
    static {
        ...
        MODULE.addSerializer(NamedUserScope.class, new NamedUserScopeSerializer());
        MODULE.addSerializer(NamedUserScopedPayload.class, new NamedUserScopedPayloadSerializer());
