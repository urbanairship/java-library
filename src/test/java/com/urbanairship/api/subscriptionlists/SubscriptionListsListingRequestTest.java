...
public class SubscriptionListsListingRequestTest {
    ...
    public void testReportParser() throws Exception {
        ...
        SubscriptionListView subscriptionListView1 = new SubscriptionListView("example_listId-1","A nice readable name 1",null, immutableScopes1);

        List<String> scopes2 = new ArrayList<>();
        scopes2.add("app");
        scopes2.add("web");
        ImmutableList<String> immutableScopes2 = ImmutableList.copyOf(scopes2);
        SubscriptionListView subscriptionListView2 = new SubscriptionListView("example_listId-2","A nice readable name 2","A very nice description for you.", immutableScopes2);
