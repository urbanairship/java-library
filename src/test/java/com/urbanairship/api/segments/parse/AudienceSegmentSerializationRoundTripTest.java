...
public class AudienceSegmentSerializationRoundTripTest {
    ...
    @Test
    public void testRoundTripWithLastSeenFlagOnLocationPredicateWithDate() throws Exception {

        AudienceSegment segment = AudienceSegment.newBuilder()
                .setDisplayName("Test display name")
                .setRootPredicate(new LocationPredicate(new LocationIdentifier(LocationAlias.newBuilder()
                        .setAliasType("us_state")
                        .setAliasValue("OR")
                        .build()),
                        new RecentDateRange(DateRangeUnit.DAYS, 4), PresenceTimeframe.LAST_SEEN))
                .build();
    ...
    @Test
    public void testRoundTripWithLastSeenOnLocationPredicateNoDate() throws Exception {
        AudienceSegment segment = AudienceSegment.newBuilder()
                .setDisplayName("Test display name")
                .setRootPredicate(new LocationPredicate(new LocationIdentifier(LocationAlias.newBuilder()
                        .setAliasType("us_zip")
                        .setAliasValue("97217")
                        .build()),
                        new RecentDateRange(DateRangeUnit.HOURS, 1), PresenceTimeframe.LAST_SEEN))
                .build();
    ...
    @Test
    public void testRoundTripWithLastSeenOnLocationPredicateNoDateWithCount() throws Exception {
        AudienceSegment segment = AudienceSegment.newBuilder()
                .setDisplayName("Test display name")
                .setRootPredicate(new LocationPredicate(new LocationIdentifier(LocationAlias.newBuilder()
                        .setAliasType("us_zip")
        ...
        AudienceSegment segmentWithCount = segment.toBuilder().setCount(12L).build();
        String serialized = mapper.writeValueAsString(segmentWithCount);

        Assert.assertEquals(segmentWithCount, mapper.readValue(serialized, AudienceSegment.class));
    }
}
