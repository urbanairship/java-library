...
public class BatchPushRequestTest {
    ...
    BatchPushRequest pushRequest = BatchPushRequest.newRequest(payload).addRequest(payload2);
    BatchPushRequest validateRequest = BatchPushRequest.newRequest(payload).addRequest(payload2).setValidateOnly(true);
