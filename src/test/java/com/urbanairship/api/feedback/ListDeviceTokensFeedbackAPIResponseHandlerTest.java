...
public class ListDeviceTokensFeedbackAPIResponseHandlerTest
{
    /* Header keys, values */
    ...
    public void testHandleSuccess() {
        ...
        ListDeviceTokensFeedbackAPIResponseHandler handler = new ListDeviceTokensFeedbackAPIResponseHandler();

        try {
            APIClientResponse<List<APIDeviceTokensFeedbackResponse>> response =
