...
| `GH_APP_ID` | Sonatype Release — `Airship Java Release Bot` App ID (numeric), used to sync `urbanairship/java-library` |
| `GH_APP_PRIVATE_KEY` | Sonatype Release — `Airship Java Release Bot` private key PEM, used to sync `urbanairship/java-library` |
